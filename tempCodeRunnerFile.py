...
class MusicPlayer:
    def __init__(self, root):
        ...
        # Load placeholder image (700x700)
        self.album_image = Image.open("placeholder.png").resize((700, 700))
        ...
        # Song title label
        self.song_label = ctk.CTkLabel(root, text="No song loaded", font=("Arial", 18))
